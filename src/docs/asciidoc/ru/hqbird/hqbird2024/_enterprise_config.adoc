...
Существует 2 популярных способа скопировать архивные сегменты с главного сервера на серверы-реплики: через общий сетевой ресурс и с помощью Cloud Backup на главном сервере и Cloud Backup Receiver на реплике.
