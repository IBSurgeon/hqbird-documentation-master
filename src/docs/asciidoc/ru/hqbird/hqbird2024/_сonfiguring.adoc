...
Выберите его, нажав btn:[Add Firebird engine to monitoring >>]

Если вы не видите экземпляр Firebird в списке автоматического обнаружения, вы можете выбрать btn:[Add custom >>] и настроить параметры экземпляра вручную.
