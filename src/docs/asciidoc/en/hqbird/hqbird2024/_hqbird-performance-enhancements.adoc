...
[NOTE]
====
The branch with materialized views functionality is currently in the final stages of development and testing. This feature will be included in HQbird for Firebird 5.0 in a future update.
====
