...
Instead of UDR nanodbc, you can use the higher-level and more familiar `EXECUTE STATEMENT ON EXTERNAL` interface. For more details see <<_eds_other_dbms_odbc>>
====
