...
In the example below we will install HQbird Enterprise with Firebird 5.0 into `c:\HQbird`, configuration will be `c:\HQbirdData\config`, output in `c:\HQbirdData\output`.
