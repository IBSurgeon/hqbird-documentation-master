...
include::fbstreaming_plugins/_kafka_cdc_plugin.adoc[leveloffset=2]
include::fbstreaming_plugins/_rabbitmq_plugin.adoc[leveloffset=2]
include::fbstreaming_plugins/_mongodb_events_plugin.adoc[leveloffset=2]
include::fbstreaming_plugins/_fts_lucene_plugin.adoc[leveloffset=2]
include::fbstreaming_plugins/_simple_json_plugin.adoc[leveloffset=2]
